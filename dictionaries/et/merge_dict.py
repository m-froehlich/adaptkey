# Merges the real Estonian-Wikipedia-dump frequency counts (wiki_dump_freq.tsv, from extract_wiki_dump.py)
# with POS tags from the English Wiktionary's own coverage of Estonian (wiktionary_allpos.tsv, from
