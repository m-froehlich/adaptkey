# -*- coding: utf-8 -*-
# One-off script: merges the English-Wiktionary-coverage Azerbaijani extracts (from extract_wiktionary.py)
# with the existing dictionaries/az/dict.tsv. Same scope discipline, collision rule, case-match safeguard,
# and append-not-resort convention as dictionaries/ru/merge_wiktionary.py / dictionaries/pl/merge_wiktionary.py.
#
