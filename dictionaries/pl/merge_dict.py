# Merges the real Polish-Wikipedia-dump frequency counts (wiki_dump_freq.tsv, from extract_wiki_dump.py)
# with real POS tags from kaikki.org's NATIVE Polish Wiktionary extract (wiktionary_allpos.tsv, from
...
# dictionaries/it/merge_dict.py/dictionaries/nl/merge_dict.py.
...
def resolve_tags(kaikki_cats: set) -> str:
    ...
    # Mandatory bare-noun safety check (Language Contribution Guide step 4, D-444): Polish DOES capitalise
