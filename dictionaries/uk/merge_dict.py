# Merges the real Ukrainian-Wikipedia-dump frequency counts (wiki_dump_freq.tsv, from extract_wiki_dump.py)
# with POS tags from the ENGLISH-Wiktionary-coverage fallback (wiktionary_allpos.tsv, from
# extract_wiktionary.py - Ukrainian has no native Wiktionary edition, see that script's own module docstring)
# into the initial dict.tsv. Directly modelled on dictionaries/ru/merge_dict.py. Ukrainian is a genuinely
# prepositional language - no Turkish-style prep-tag gap.
