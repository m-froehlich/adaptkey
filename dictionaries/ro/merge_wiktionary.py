# -*- coding: utf-8 -*-
# One-off script: merges the Romanian Wiktionary extracts (from extract_wiktionary.py, the English
# Wiktionary's own coverage of Romanian - no native edition exists) with the existing
# dictionaries/ro/dict.tsv. Same scope discipline, collision rule, case-match safeguard, and
# append-not-resort convention as dictionaries/pl/merge_wiktionary.py - see that file's own comments for the
# full reasoning behind each point.
#
