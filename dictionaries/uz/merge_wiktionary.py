# -*- coding: utf-8 -*-
# One-off script: merges the English-Wiktionary-coverage Uzbek extracts (from extract_wiktionary.py) with the
# existing dictionaries/uz/dict.tsv. Same scope discipline, collision rule, case-match safeguard, and
