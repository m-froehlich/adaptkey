# -*- coding: utf-8 -*-
# One-off script: merges the Dutch Wiktionary extracts (from extract_wiktionary.py, the native Dutch
# WikiWoordenboek edition) with the existing dictionaries/nl/dict.tsv. Same scope discipline, collision
# rule, case-match safeguard, and append-not-resort convention as dictionaries/fr/merge_wiktionary.py/
# dictionaries/pt/merge_wiktionary.py - see those files' own comments for the full reasoning behind each
# point. Like Italian's own round, Dutch's native edition documents noun/adjective inflection very richly
# (see extract_wiktionary.py's own module docstring for the real numbers, including genuine "diminutive"
# noun forms), so this script completes real Wortfamilien paradigms for all three categories.
#
