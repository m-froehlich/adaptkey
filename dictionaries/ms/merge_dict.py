# Merges the real Malay-Wikipedia-dump frequency counts (wiki_dump_freq.tsv, from extract_wiki_dump.py) with
# real POS tags from kaikki.org's NATIVE Malay Wiktionary extract (wiktionary_allpos.tsv, from
...
#
# D-450 note: this source has no "prep"/"prep_phrase" tagged entries at all (confirmed directly) - Malay's
# own prepositions are not documented under this closed-class tag in this edition. `dict.tsv` therefore has
# 0 PREPOSITION rows for Malay, a genuine source characteristic, not a bug.
