# -*- coding: utf-8 -*-
# One-off script: merges the Italian Wiktionary extracts (from extract_wiktionary.py, the native Italian
# Wikizionario edition) with the existing dictionaries/it/dict.tsv. Same scope discipline, collision rule,
# case-match safeguard, and append-not-resort convention as dictionaries/fr/merge_wiktionary.py/
# dictionaries/pt/merge_wiktionary.py - see those files' own comments for the full reasoning behind each
# point. Unlike Portuguese's own round, Italian's native edition documents noun/adjective inflection richly
# (see extract_wiktionary.py's own module docstring for the real numbers), so this script completes real
# Wortfamilien paradigms for all three categories (nouns/verbs/adjectives), not verbs alone.
#
