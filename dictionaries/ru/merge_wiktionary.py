# -*- coding: utf-8 -*-
# One-off script: merges the native Russian Wiktionary extracts (from extract_wiktionary.py) with the
# existing dictionaries/ru/dict.tsv. Same scope discipline, collision rule, case-match safeguard, and
# append-not-resort convention as dictionaries/pl/merge_wiktionary.py / dictionaries/sr/merge_wiktionary.py -
# see those files' own comments for the full reasoning behind each point.
#
