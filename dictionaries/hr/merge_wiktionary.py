# -*- coding: utf-8 -*-
# One-off script: merges the shared Serbo-Croatian Wiktionary extracts (from
# dictionaries/sh/extract_wiktionary.py, Latin-script variant, copied here) with the existing
# dictionaries/hr/dict.tsv. Same scope discipline, collision rule, case-match safeguard, and
