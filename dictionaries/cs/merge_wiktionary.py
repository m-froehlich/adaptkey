# -*- coding: utf-8 -*-
# One-off script: merges the Czech Wiktionary extracts (from extract_wiktionary.py, the native Czech
# Wikislovník edition) with the existing dictionaries/cs/dict.tsv. Same scope discipline, collision rule,
# case-match safeguard, and append-not-resort convention as dictionaries/pl/merge_wiktionary.py - see that
# file's own comments for the full reasoning behind each point.
#
