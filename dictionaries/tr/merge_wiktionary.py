# -*- coding: utf-8 -*-
# One-off script: merges the Turkish Wiktionary extracts (from extract_wiktionary.py, the native Turkish
# Vikisözlük edition) with the existing dictionaries/tr/dict.tsv. Same scope discipline, collision rule,
# case-match safeguard, and append-not-resort convention as dictionaries/pl/merge_wiktionary.py - see that
# file's own comments for the full reasoning behind each point. Turkish's own native edition documents
# noun/adjective inflection extremely richly (see extract_wiktionary.py's own module docstring for the real
# numbers), so this script completes real Wortfamilien paradigms for all three categories.
#
