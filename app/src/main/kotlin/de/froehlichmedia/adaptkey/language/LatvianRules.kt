...
/**
 * D-450: the Latvian [LanguageRules] implementation - built via the Language Contribution Guide's own §8
 * pipeline, from the English Wiktionary's own coverage of Latvian (no native edition exists on kaikki.org,
 ...
 * German-specific compounding/inflection grammar with no Latvian equivalent implemented yet.
 */
object LatvianRules : LanguageRules {
    ...
    /** Latvian has no single-word equivalent to German's S-08 "Uhr" convention after a typed time. */
    ...
    /** Latvian writes decimals with a comma ("3,14"), like every other implemented language here. */
