...
/**
 * D-450: the Bosnian [LanguageRules] implementation - built via the Language Contribution Guide's own §8
 * pipeline, from the shared "Serbo-Croatian" Wiktionary edition's own Latin-script coverage (no separate
 * native Bosnian edition exists - kaikki.org treats Croatian/Bosnian/Serbian as one shared language, see
 ...
 * German-specific compounding/inflection grammar with no Bosnian equivalent implemented yet.
 */
object BosnianRules : LanguageRules {
    ...
    /** Bosnian has no single-word equivalent to German's S-08 "Uhr" convention after a typed time. */
    ...
    /** Bosnian writes decimals with a comma ("3,14"), like every other implemented language here. */
