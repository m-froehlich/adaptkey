...
/**
 * D-450: the Hungarian [LanguageRules] implementation - built via the Language Contribution Guide's own §8
 * pipeline, from the English Wiktionary's own coverage of Hungarian (no native edition exists on kaikki.org,
 ...
 * German-specific compounding/inflection grammar with no Hungarian equivalent implemented yet - Hungarian's
 * own real agglutinative case system is a much larger, separate undertaking, not attempted here.
 */
object HungarianRules : LanguageRules {
    ...
    /** Hungarian has no single-word equivalent to German's S-08 "Uhr" convention after a typed time. */
    ...
    /** Hungarian writes decimals with a comma ("3,14"), like every other implemented language here. */
