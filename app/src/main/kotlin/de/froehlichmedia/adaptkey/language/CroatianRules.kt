...
/**
 * D-450: the Croatian [LanguageRules] implementation - built via the Language Contribution Guide's own §8
 * pipeline, from the shared "Serbo-Croatian" Wiktionary edition's own Latin-script coverage (no separate
 * native Croatian edition exists - kaikki.org treats Croatian/Bosnian/Serbian as one shared language, see
 ...
 * German-specific compounding/inflection grammar with no Croatian equivalent implemented yet.
 */
object CroatianRules : LanguageRules {
    ...
    /** Croatian has no single-word equivalent to German's S-08 "Uhr" convention after a typed time. */
    ...
    /** Croatian writes decimals with a comma ("3,14"), like every other implemented language here. */
