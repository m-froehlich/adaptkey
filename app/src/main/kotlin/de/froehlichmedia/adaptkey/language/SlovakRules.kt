...
/**
 * D-450: the Slovak [LanguageRules] implementation - built via the Language Contribution Guide's own §8
 * pipeline, from the English Wiktionary's own coverage of Slovak (no native edition exists on kaikki.org,
 * confirmed directly - and this particular fallback source turned out the smallest of any language pack this
 * project has built, see `AdaptKey-Progress.md`'s own D-450 entry). Like every other implemented language,
 ...
 * hooks encode German-specific compounding/inflection grammar with no Slovak equivalent implemented yet.
 */
object SlovakRules : LanguageRules {
    ...
    /** Slovak has no single-word equivalent to German's S-08 "Uhr" convention after a typed time. */
    ...
    /** Slovak writes decimals with a comma ("3,14"), like every other implemented language here. */
