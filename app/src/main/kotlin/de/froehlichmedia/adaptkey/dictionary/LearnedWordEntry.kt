...
/**
 * D-388: one row of [DictionaryStore.learnedWordsWithTimestamp] - a learned word together with when it was
 * last written (promoted, reinforced, re-cased, or restored from a backup), for the Learned Words editor's
 * own recency sort.
 *
