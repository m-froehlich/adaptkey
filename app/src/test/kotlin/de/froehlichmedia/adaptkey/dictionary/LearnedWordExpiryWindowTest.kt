...
class LearnedWordExpiryWindowTest {
    ...
    @Test
    fun `each level's own day count is ordered early less than medium less than late`() {
        assertEquals(90, LearnedWordExpiryWindow.EARLY.days)
        assertEquals(180, LearnedWordExpiryWindow.MEDIUM.days)
